...
en los atributos del objeto. Después, a través de otro método calcular y devolver la distancia que existe entre los dos puntos 
...
public class Punto {
    ...
    public void crearPuntos(){
        System.out.println("ingresar el punto X1");
        x1 = leer.nextDouble();
